    ...
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                @if ($tasks->count() > 0)
                    <p class="text-gray-500 mt-1">You have {{ $tasks->count() }}
                        {{ $tasks->count() === 1 ? 'task' : 'tasks' }} registered</p>
                @endif
            </div>
            <a href="/tasks/create"
        ...
        @if ($tasks->count() > 0)
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                @foreach ($tasks as $task)
                    <div
                        class="bg-gray-900 border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                                ...
                                <tr class="hover:bg-gray-700">
                                    <td class="px-6 py-4">
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-400 truncate max-w-xs">{{ $task->description }}
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium space-x-2">
                                        <a href="/tasks/{{ $task->id }}"
                                            class="text-indigo-500 hover:text-indigo-300">View</a>
                                        <a href="/tasks/{{ $task->id }}/edit"
