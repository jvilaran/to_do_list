            ...
            <form action="/tasks/{{ $task->id }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $task->title) }}"
                        class="placeholder-gray-400 text-white w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('title') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="placeholder-gray-400 text-white w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('description') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <select id="status" name="status"
                        class="text-white bg-gray-800 w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('status') border-red-300 @enderror"
                        required>
