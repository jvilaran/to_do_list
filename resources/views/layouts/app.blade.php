            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center">
                    <h1 class="text-xl font-semibold text-white">
                        <a href="/" class="hover:text-indigo-600 transition-colors"><i
                                class="fa-solid fa-list-check"></i> To-Do List</a>
                    </h1>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <a href="/"
                        class="text-gray-400 hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium transition-colors 
    ...
    <footer class="bg-gray-900 border-t border-indigo-500 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <p class="text-center text-gray-500 text-sm">
                © {{ date('Y') }} My To-Do List App. Created with <i class="fa-solid fa-heart"></i> and Laravel +
                Tailwind CSS
            </p>
        </div>
    </footer>
